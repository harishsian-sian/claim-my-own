...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "ded508-e8.myshopify.com";
export const SHOPIFY_STOREFRONT_TOKEN = "33b408a7018fba50742f111f637c4485";
...
export const BEST_SELLERS_QUERY = `
  query GetBestSellers($first: Int!, $query: String) {
