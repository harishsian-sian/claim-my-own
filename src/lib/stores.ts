...
export const STORES: StoreLocation[] = [
  {
    ...
    mapsUrl: "https://www.google.com/maps/search/?api=1&query=MeltonSupps+391+High+Street+Melton+VIC+3337",
    embedUrl: "https://www.google.com/maps?q=391+High+Street+Melton+VIC+3337&output=embed",
    tagline: "Your local supplement HQ in Melton.",
    intro:
      "Visit MeltonSupps at 391 High Street, Melton for Australia's best sports nutrition, vitamins and wellness brands — all at unbeatable prices. Friendly expert staff are ready to help you smash your goals.",
  },
  {
    handle: "braybrook",
